                          ...
                          <div class="main-menu  d-none d-lg-block">
                              <nav>
                                  <ul id="navigation">
                                      ...
                                      <li><a href="login/recursos/login1.php">ADM</a></li>
                                      <li><a href="login/recursos/login2.php">Medico</a></li>
                                      <li><a href="login/recursos/login3.php">Paciente</a></li>
                                      <li><a href="html/nosotros.html">Nosotros</a></li>
                                      <li><a href="html/especialidad.html">Especialidades</a></li>
