...
$mensajeError2FA = ""; // Inicializa una variable para almacenar mensajes de error relacionados con el 2FA
// Verifica si la solicitud es de tipo POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Obtiene el valor del código 2FA desde el formulario o establece una cadena vacía si no está presente
    $codigo2FA = $_POST['codigo2FA'] ?? '';
    // Verifica si la casilla de 2FA está habilitada y si el código 2FA ingresado no es "123"
    if (isset($_POST['2faEnabled']) && $_POST['2faEnabled'] === 'on' && $codigo2FA !== "123") {
        // Si las condiciones no se cumplen, establece un mensaje de error
